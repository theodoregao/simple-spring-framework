...
public class ProxyDemo {
  public static void main(String[] args) {
    ...
    //        AlipayInvocationHandler invocationHandler = new
    // AlipayInvocationHandler(commonPayment);
    //        CommonPayment commonPaymentProxy = JdkDynamicProxyUtil.newProxyInstance(commonPayment,
    // invocationHandler);
